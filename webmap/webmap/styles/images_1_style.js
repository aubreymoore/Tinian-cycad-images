var size = 0;
var placement = 'point';
function categories_images_1(feature, value, size, resolution, labelText,
...
var style_images_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("cas_present");
    var labelText = "";
    size = 0;
...
var style = categories_images_1(feature, value, size, resolution, labelText,
